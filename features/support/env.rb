...
Before('@omniauth_facebook_test_success') do
...
Before('@omniauth_google_test_success') do
  OmniAuth.config.test_mode = true
  Capybara.default_host = 'http://localhost:3000'
...
After('@omniauth_facebook_test_success') do
  OmniAuth.config.test_mode = false
end
After('@omniauth_google_test_success') do
  OmniAuth.config.test_mode = false
end
